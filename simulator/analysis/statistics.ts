...
export class StatisticsAnalyzer {
  ...
  calculateFirstPlayerAdvantage(simulations: SimulationResult[]): FirstPlayerAdvantage[] {
  ...
  calculateGameLengthDistribution(simulations: SimulationResult[]): Map<number, number> {
  ...
  calculateStrategyPerformance(simulations: SimulationResult[]): StrategyPerformance[] {
