    ...
    <div className="card">
      <div className="card-header">
        <div>
          ...
          <p className="card-subtitle">Win percentage by character across all games</p>
        </div>
      </div>
        ...
        <>
          <div className="stats-grid">
            {data.map(char => (
              <div key={char.character} className="stat-card">
                ...
                <div className="stat-detail">{char.wins} / {char.games}</div>
              </div>
            ))}
          </div>
          ...
          <div className="chart-legend">
            <span className="legend-item">
              <span className="legend-line" style={{ backgroundColor: '#95a5a6' }} />
...
const ReferenceLine: React.FC<any> = ({ y, stroke, strokeDasharray, label }) => {
