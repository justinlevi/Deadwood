...
const FirstPlayerAdvantage: React.FC<FirstPlayerAdvantageProps> = ({ simulations }) => {
  const data = useMemo(() => {
                ...
                <div key={pos.position} className="position-card">
                  <div className="position-header">
                    ...
                    <span 
                      ...
                      style={{ 
                        color: pos.winRate > expectedWinRate ? '#2ecc71' : '#e74c3c' 
                      }}
                    >
                  ...
                  <div className="position-stats">
                    <span>{pos.wins} wins / {pos.games} games</span>
                  </div>
                </div>
              ))}
            </div>
