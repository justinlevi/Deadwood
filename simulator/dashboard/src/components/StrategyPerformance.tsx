        ...
        <>
          ...
          <div className="strategy-descriptions">
            ...
            <div className="description-list">
              ...
              <div className="description-item">
                <strong>greedy:</strong> Maximizes influence gain at every
                opportunity
              </div>
              <div className="description-item">
                <strong>balanced:</strong> Balances influence, positioning, and
                disruption
              </div>
              <div className="description-item">
                <strong>aggressive:</strong> Focuses on challenging opponents
                and controlling key locations
              </div>
              <div className="description-item">
                <strong>defensive:</strong> Avoids confrontation and builds
                influence in safe locations
              </div>
              <div className="description-item">
                <strong>mcts:</strong> Uses Monte Carlo Tree Search for decision
                making
              </div>
            </div>
          </div>
