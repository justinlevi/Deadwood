...
const LocationCard: React.FC<Props> = ({
  ...
  const baseClasses = "relative min-h-[120px] lg:min-h-[140px] 2xl:min-h-[160px] h-full flex flex-col p-3 lg:p-4 rounded-lg border-4 transition-all duration-200 bg-cover bg-center bg-no-repeat"
